...
## Уравнения
Форматтер имеет поддержку LaTeX. Это позволяет набирать уравнения прямо в текстовом файле, что особенно удобно, например, в VSCode с расширением Markdown+Math. Это сделано Для особо сложных уравнений возможно написать `$$` и в документе появится уравнение с текстом
